    ...
    <div className="max-w-[1640px] mx-auto p-4 py-5 grid md:grid-cols-3 gap-6">
      ...
      <div className="rounded-xl relative">
        ...
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          <p className="font-bold text-2xl px-2 pt-4">STACK Eats Out</p>
          <p className="px-2">Through 8/26</p>
          <button className="border-white bg-gray text-[var(--orange)] font-bold mx-2 absolute bottom-4">
            Order Now
          </button>
        </div>
        <img
          className="max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl"
          src="https://images.pexels.com/photos/6262251/pexels-photo-6262251.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          alt="/"
        />
      </div>
      {/* Card */}
